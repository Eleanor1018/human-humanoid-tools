...
| **Agent（JSON CLI / MCP）** | 带版本契约的 H2R、无场景 R2R 与有界 Batch 自动化 | [`hhtools agent` / `hhtools-mcp`](docs/agent.md) |
...
当前 Agent 接口覆盖经过 preflight 的安全 H2R、无场景 R2R、有界 H2R/R2R Batch 任务和
