  ...
  >
    ...
    <aside id="inspector" class="side-panel">
      <div class="side-panel-head">
        ...
        <button type="button" class="panel-hide-btn" id="hide-inspector" title="隐藏右栏" @click="panelLayout.setHidden('inspector', true)">▶</button>
      </div>
